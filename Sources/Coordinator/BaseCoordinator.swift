...
//    }
//
//    struct DiffableValueStruct<Coordinator: BaseCoordinator> {
...
//        let diffableValue: DiffableValueStruct<Coordinator>
...
//
//        var type: Cases
//        var diffable: () -> DiffableValueStruct<Coordinator> = { fatalError() }
...
//    typealias AnyDiffableSourceValue = DiffableValueStruct<BaseCoordinator>
...
//}
//
//extension BaseCoordinator.DiffableValueStruct: DiffEquatable {
//    func diffEqual(to other: Self, default value: Bool) -> Bool {
